...
function LoginPage() {
  ...
  return (
    <div className="w-full h-screen bg-login bg-no-repeat bg-cover bg-center bg-fixed">
      <div className="max-w-7xl mx-auto  h-full  flex items-center px-3 justify-center">
        <div className="shadow-2xl rounded-lg w-[500px]  flex flex-col items-center font-serif gap-5 p-5">
          ...
          >
            ...
            <button
              type="submit"
              className="uppercase mt-3 bg-pink-500 py-2 rounded-lg hover:bg-pink-400 active:bg-pink-500 text-slate-100 font-semibold shadow-sm"
            >
              Sign in
            </button>
          </form>
